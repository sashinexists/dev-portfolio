                  ...
                  { view =
                      \model ->
                          case model.page of
                              ...
                              _ ->
                                  { title = "Model mismatch", body = Html.text <| "Model mismatch" }
                  , head = Page.Testimonials.page.head
                      { data = data
                      , sharedData = globalData
                      , routeParams = {}
                      , path = page.path
                  ...
                  { view =
                      \model ->
                          case model.page of
                              ...
                              _ ->
                                  { title = "Model mismatch", body = Html.text <| "Model mismatch" }
                  , head = Page.Blog.Name_.page.head
                      { data = data
                      , sharedData = globalData
                      , routeParams = s
                      , path = page.path
                  ...
                  { view =
                      \model ->
                          case model.page of
                              ...
                              _ ->
                                  { title = "Model mismatch", body = Html.text <| "Model mismatch" }
                  , head = Page.Project.Name_.page.head
                      { data = data
                      , sharedData = globalData
                      , routeParams = s
                      , path = page.path
                  ...
                  { view =
                      \model ->
                          case model.page of
                              ...
                              _ ->
                                  { title = "Model mismatch", body = Html.text <| "Model mismatch" }
                  , head = Page.Skill.Name_.page.head
                      { data = data
                      , sharedData = globalData
                      , routeParams = s
                      , path = page.path
                  ...
                  { view =
                      \model ->
                          case model.page of
                              ...
                              _ ->
                                  { title = "Model mismatch", body = Html.text <| "Model mismatch" }
                  , head = Page.Testimonial.Name_.page.head
                      { data = data
                      , sharedData = globalData
                      , routeParams = s
                      , path = page.path
...
main : Pages.Internal.Platform.Cli.Program (Maybe Route)
main =
